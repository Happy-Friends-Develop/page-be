...
public class UserController {
    ...
    public Resp<List<UserResponse>> getUsersInfo() {
        return Resp.ok(userService.findUsersInformation());
    }

    @Operation(summary = "유저 정보 수정", description = "회원의 정보를 변경합니다.")
    @PutMapping("/api/user/{id}")
    public UserResponse updateUserInfo(@PathVariable Long id, @RequestBody UserUpdateRequest userUpdateRequest) {
    ...
    public Resp<UserResponse> blacklistUser(
    ...
    public Resp<UserResponse> unblacklistUser(
            @PathVariable Long userId,
