...
public class ScheduleController {
    ...
    public Resp<List<ScheduleResponse>> getSchedulesForBoard(
    ...
    public Resp<String> addSchedulesToBoard(
    ...
    public Resp<String> updateSchedule(
        ...
        return Resp.ok("스케줄이 성공적으로 수정되었습니다.");
    }
    ...
    public Resp<String> deleteSchedule(
            @Parameter(description = "게시글의 ID") @PathVariable Long boardId,
        ...
        return Resp.ok("스케줄이 성공적으로 삭제되었습니다.");
    }
}
